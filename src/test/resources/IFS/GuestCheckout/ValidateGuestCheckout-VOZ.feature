#############################################################################################
# This Feature file will test the the E2E functionality of Guest Checkout for VOZ
...
Feature: Validate Guest Checkout VOZ


  Scenario Outline: Validate a successful VOZ guest checkout with a VISA card for all applicable productCodes
    ...
    Examples:
      ...
      | MOBILE      | VOZ         | 0VOZQE     | VATIDB0060  | en_US  | USD      |
      | LAPTOP      | VOZ         | 0VOZQE     | VATIDB0060  | en_US  | USD      |
  ...
  @Positive
  Scenario Outline: Validate a successful VOZ guest checkout with an MC card for all applicable productCodes
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful VOZ guest checkout with an AMEX card for all applicable productCodes
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a guest checkout to VOZ with an invalid card
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a VOZ guest checkout with an invalid uxdid
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a VOZ guest checkout with an invalid zip code format
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a guest checkout to VOZ with an invalid product code
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a VOZ guest checkout with a DISCOVER card does not work
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
    ...
    And the JSON response should be the following:
      ...
      | statusMsg  | Bad Request                                                             |
      | errorCode  | 100                                                                     |
      | errorMsg   | {errorCode=100, errorDescription=905 Payment details are not supported} |
    Examples:
      | sessionType | airlineCode | tailNumber | productCode | locale | currency |
      | MOBILE      | VOZ         | 0VOZQE     | VATIDB0060  | en_US  | USD      |