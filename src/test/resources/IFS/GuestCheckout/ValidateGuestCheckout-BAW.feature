#############################################################################################
# This Feature file will test the the E2E functionality of Guest Checkout for BAW
...
Feature: Validate Guest Checkout BAW


  Scenario Outline: Validate a successful BAW guest checkout with a VISA card for all applicable productCodes
    ...
    Examples:
      ...
      | MOBILE      | BAW         | 0BAQE      | BATHAA0240  | en_US  | USD      |
      | LAPTOP      | BAW         | 0BAQE      | BATHAA0240  | en_US  | USD      |
  ...
  Scenario Outline: Validate a successful BAW guest checkout with a VISA card for all applicable productCodes
    ...
    Examples:
      | sessionType | airlineCode | tailNumber | productCode | locale | currency |
      | MOBILE      | BAW         | 0BAQE      | BATHAA0240  | en_US  | USD      |
      | MOBILE      | BAW         | 0BAQE      | BATIAA0240  | en_US  | USD      |
      | MOBILE      | BAW         | 0BAQE      | BATHAA0060  | en_US  | USD      |
      | MOBILE      | BAW         | 0BAQE      | BATIAA0060  | en_US  | USD      |
      | MOBILE      | BAW         | 0BAQE      | BASHAA0001  | en_US  | USD      |
      | MOBILE      | BAW         | 0BAQE      | BASIAA0001  | en_US  | USD      |
      | LAPTOP      | BAW         | 0BAQE      | BATHAA0240  | en_US  | USD      |
      | LAPTOP      | BAW         | 0BAQE      | BATIAA0240  | en_US  | USD      |
      | LAPTOP      | BAW         | 0BAQE      | BATHAA0060  | en_US  | USD      |
      | LAPTOP      | BAW         | 0BAQE      | BATIAA0060  | en_US  | USD      |
      | LAPTOP      | BAW         | 0BAQE      | BASHAA0001  | en_US  | USD      |
      | LAPTOP      | BAW         | 0BAQE      | BASIAA0001  | en_US  | USD      |

  @Positive
  Scenario Outline: Validate a successful BAW guest checkout with an MC card for all applicable productCodes
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful BAW guest checkout with an AMEX card for all applicable productCodes
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful BAW guest checkout with a VISA card for all applicable productCodes in all available locales
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
    ...
    Examples:
      | sessionType | airlineCode | tailNumber | productCode | locale | currency |
      | MOBILE      | BAW         | 0BAQE      | BATHAA0240  | es_ES  | USD      |
      | MOBILE      | BAW         | 0BAQE      | BATHAA0240  | es_ES  | GBP      |
      | MOBILE      | BAW         | 0BAQE      | BATHAA0240  | es_ES  | EUR      |
      | MOBILE      | BAW         | 0BAQE      | BATHAA0240  | en_GB  | USD      |
      | MOBILE      | BAW         | 0BAQE      | BATHAA0240  | en_GB  | GBP      |
      | MOBILE      | BAW         | 0BAQE      | BATHAA0240  | en_GB  | EUR      |
      | LAPTOP      | BAW         | 0BAQE      | BATHAA0240  | es_ES  | USD      |
      | LAPTOP      | BAW         | 0BAQE      | BATHAA0240  | es_ES  | GBP      |
      | LAPTOP      | BAW         | 0BAQE      | BATHAA0240  | es_ES  | EUR      |
      | LAPTOP      | BAW         | 0BAQE      | BATHAA0240  | en_GB  | USD      |
      | LAPTOP      | BAW         | 0BAQE      | BATHAA0240  | en_GB  | GBP      |
      | LAPTOP      | BAW         | 0BAQE      | BATHAA0240  | en_GB  | EUR      |

  @Negative
  Scenario Outline: Validate a guest checkout to BAW with an invalid card
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a BAW guest checkout with an invalid uxdid
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a BAW guest checkout with an invalid zip code format
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a guest checkout to BAW with an invalid product code
    When I generate a <sessionType> GBP SessionId with airlineCode = "<airlineCode>", tailNumber = "<tailNumber>", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
