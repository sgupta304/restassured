#############################################################################################
# This Feature file will test the the E2E functionality of payment for VIR.
...
Feature: Validate Payment VIR


  Scenario Outline: Validate a successful MOBILE purchase to VIR with a VISA
    When I generate a MOBILE GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
  ...
  Scenario Outline: Validate a successful LAPTOP purchase to VIR with a VISA
    When I generate a LAPTOP GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  Scenario Outline: Validate a successful LAPTOP purchase to VIR with a VISA
   ...
   @Positive
  Scenario Outline: Validate a successful MOBILE purchase to VIR with a SAVED VISA card
    When I generate a MOBILE GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
   ...
   @Positive
  Scenario Outline: Validate a successful LAPTOP purchase to VIR with a SAVED VISA card
    When I generate a LAPTOP GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful MOBILE purchase to VIR with an AMEX
    When I generate a MOBILE GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful LAPTOP purchase to VIR with an AMEX
    When I generate a LAPTOP GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful MOBILE purchase to VIR with a SAVED AMEX card
    When I generate a MOBILE GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful LAPTOP purchase to VIR with a SAVED AMEX card
    When I generate a LAPTOP GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful MOBILE purchase to VIR with an MC
    When I generate a MOBILE GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful LAPTOP purchase to VIR with an MC
    When I generate a LAPTOP GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful MOBILE purchase to VIR with a SAVED MC card
    When I generate a MOBILE GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful LAPTOP purchase to VIR with a SAVED MC card
    When I generate a LAPTOP GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful purchase to VIR with a VISA in all available locales and currencies
    When I generate a MOBILE GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
    ...
    Examples:
      ...
      | en_US  | USD      | VSSFDM0001  |
      | en_GB  | GBP      | VSSFDM0001  |
      | en_GB  | USD      | VSSFDM0001  |

  @Negative
  Scenario Outline: Validate a successful purchase to VIR with an invalid card
    When I generate a MOBILE GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a successful purchase to VIR with an invalid product code
    When I generate a MOBILE GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a successful purchase to VIR with an invalid user name
    When I generate a MOBILE GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a successful purchase to VIR with an invalid uxdid
    When I generate a MOBILE GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a successful purchase to VIR with an invalid zip code format
    When I generate a MOBILE GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  Scenario Outline: Validate a valid product with an invalid price
    When I generate a <sessionType> GBP SessionId with airlineCode = "VIR", tailNumber = "0VIQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
