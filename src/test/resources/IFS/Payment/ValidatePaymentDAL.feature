#############################################################################################
# This Feature file will test the the E2E functionality of payment for DAL.
...
Feature: Validate Payment DAL


  Scenario Outline: Validate a successful MOBILE purchase to DAL with a VISA
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    ...
    Given I generate an calculate order model for productCode = "DLMPRC1010", price = "%{price}", user = "%{userId}", currency = "USD", and uxdId = "%{uxdid}"
  ...
  Scenario Outline: Validate a successful LAPTOP purchase to DAL with a VISA
    When I generate a LAPTOP GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  Scenario Outline: Validate a successful LAPTOP purchase to DAL with a VISA
   ...
   @Positive
  Scenario Outline: Validate a successful MOBILE purchase to DAL with a SAVED VISA card
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
   ...
   @Positive
  Scenario Outline: Validate a successful LAPTOP purchase to DAL with a SAVED VISA card
    When I generate a LAPTOP GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful MOBILE purchase to DAL with an AMEX
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful LAPTOP purchase to DAL with an AMEX
    When I generate a LAPTOP GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful MOBILE purchase to DAL with a SAVED AMEX card
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful LAPTOP purchase to DAL with a SAVED AMEX card
    When I generate a LAPTOP GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful MOBILE purchase to DAL with a DISCOVER
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful LAPTOP purchase to DAL with a DISCOVER
    When I generate a LAPTOP GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful MOBILE purchase to DAL with a SAVED DISCOVER card
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful LAPTOP purchase to DAL with a SAVED DISCOVER card
    When I generate a LAPTOP GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful MOBILE purchase to DAL with an MC
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful LAPTOP purchase to DAL with an MC
    When I generate a LAPTOP GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful MOBILE purchase to DAL with a SAVED MC card
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful LAPTOP purchase to DAL with a SAVED MC card
    When I generate a LAPTOP GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Positive
  Scenario Outline: Validate a successful purchase to DAL with a VISA in all available locales and currencies
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
    ...
    Examples:
      ...
      | en_US  | USD      | DLMPRC1010  |
#      | zh_CN  | USD      | DLMPRC1010  |
#      | ja_JP  | JPY      | DLMPRC1010  |

  @Negative
  Scenario Outline: Validate a successful purchase to DAL with an invalid card
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a successful purchase to DAL with an invalid user name
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a successful purchase to DAL with an invalid uxdid
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a successful purchase to DAL with an invalid zip code format
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  Scenario Outline: Validate a valid product with an invalid price
    When I generate a <sessionType> GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
  ...
  @Negative
  Scenario Outline: Validate a successful purchase to DAL with an invalid product code
    When I generate a MOBILE GBP SessionId with airlineCode = "DAL", tailNumber = "0DAQE", and deviceMacAddress = "random" and store it at "uxdid"
    And I send a CloudDao GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
    And the JSON response at "uxdId" should be "%{uxdid}"
