#############################################################################################
# This Feature file will test the the E2E functionality of message bypass for DAL.
...
Feature: Validate Message Bypass - DAL
  ...
  @HealthCheck
  Scenario: Validate a successful Message Bypass request to DAL
  ...
  @Negative
  Scenario: Validate a Message Bypass to DAL with a missing security token
    When I send a GBP POST request to generate a MOBILE session
    Then the response status should be "200"
    When I send a IFSGateway GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
  ...
  @Negative
  Scenario: Validate a Message Bypass to DAL with an invalid security token
    When I send a GBP POST request to generate a MOBILE session
    Then the response status should be "200"
    When I send a IFSGateway GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
