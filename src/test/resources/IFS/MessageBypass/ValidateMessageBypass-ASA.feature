#############################################################################################
# This Feature file will test the the E2E functionality of message bypass for ASA.
...
Feature: Validate Message Bypass - ASA
  ...
  @HealthCheck
  Scenario: Validate a successful Message Bypass request to ASA
  ...
  @Negative
  Scenario: Validate a Message Bypass to ASA with a missing security token
    When I send a GBP POST request to generate a MOBILE session
    Then the response status should be "200"
    When I send a IFSGateway GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
  ...
  @Negative
  Scenario: Validate a Message Bypass to ASA with an invalid security token
    When I send a GBP POST request to generate a MOBILE session
    Then the response status should be "200"
    When I send a IFSGateway GET request to "/v2/token/%{uxdid}"
    Then the response status should be "200"
